		...
		<div className="footer container">
			<p className="footer__heading">
				...
				<span>
					...
					>
						<path
							d="M17.562 14.428c-.858.86-2.266.86-3.124 0a2.23 2.23 0 0 1 0-3.133 2.213 2.213 0 0 1 3.124 0 2.23 2.23 0 0 1 0 3.133m9.818-1.567C27.38 6.586 22.285 1.5 16 1.5 9.715 1.5 4.62 6.586 4.62 12.861c0 2.459.785 4.733 2.115 6.593h-.05l9.25 11.046 8.778-10.334c.191-.227.373-.462.546-.704l.007-.008a11.294 11.294 0 0 0 2.114-6.593"
							fill="#C3D600"
							fill-rule="evenodd"
						></path>
					</svg>
				...
				<span>
					...
					>
						<path
							fill="#CEB7FF"
							fill-rule="nonzero"
							d="M3.338 9.866l.066.067V28.5h4.701v-5.43h2.683v5.43H20.83v-5.43h2.682v5.43h5.147V15.982h-.027l.03-.03L22.3 9.584l-6.24 6.242v-5.93h-.026l.031-.03L9.701 3.5z"
						></path>
					</svg>
				</span>
				you'll love
			...
			<div class="links-container">
				<div className="links-list">
					...
					<p>Arizona Real Estate</p>
					<p>Arkansas Real Estate</p>
				</div>
				<div className="links-list">
					<h5>Popular Searches</h5>
					<p>Apartments for Rent Near Me</p>
					<p>Houses for Rent Near Me</p>
					<p>Houses for Sale Near Me</p>
					<p>Houses for Sale Near Me by Owner</p>
				</div>
				<div className="links-list">
				...
				<div className="links-list">
					...
					<p>U.S. Property Records</p>
					<p>Popular Counties</p>
					<p>Rental Communities</p>
					<p>Real Estate Leads</p>
				</div>
			</div>
			<p className="copyright">
				Copyright © 2020 Trulia, LLC. All rights reserved. Equal Housing
				Opportunity. Have a Question? Visit our Help Center to find the answer.
			</p>
			<svg
				width="704"
				height="113"
